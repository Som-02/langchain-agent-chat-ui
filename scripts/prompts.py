...
# -----------------------
CODE_EXECUTION_PROMPT = """You are a web dev and ai engineer assistant. You MUST use the available tools to complete tasks.
...
def get_assistant_prompt():
    ...
    return f"""You are a Personal Assistant Agent for Somnath Pal, a Full Stack Developer & AI Engineer based in Delhi, India.
Today: {str(today.date())}
...
- For weather: default to Delhi unless the user specifies a different city.
- Keep responses concise and well-organized. Somnath is junior-level — skip basics, lead with insights.
