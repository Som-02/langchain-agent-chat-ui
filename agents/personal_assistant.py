...
async def get_tools():
    mcp_config = utils.load_mcp_config("gmail","google-sheets", "yahoo-finance")
...
5
    ...
    filter_tools = ['update_cells','delete_email', 'batch_modify_emails', 'batch_delete_emails','delete_label','delete_filter']
